 ...
 *
 */
function(){"use strict";var e=Boolean("localhost"===window.location.hostname||"[::1]"===window.location.hostname||window.location.hostname.match(/^127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}$/));"serviceWorker"in navigator&&("https:"===window.location.protocol||e)&&navigator.serviceWorker.register("service-worker.js").then(function(e){e.onupdatefound=function(){if(navigator.serviceWorker.controller){var t=e.installing;t.onstatechange=function(){switch(t.state){case"installed":break;case"redundant":throw new Error("The installing service worker became redundant.")}}}}})["catch"](function(e){console.error("Error during service worker registration:",e)}),$(".slider-project, .slider-projectTwo").slick({dots:!0,arrows:!0,infinite:!0,speed:300,slidesToShow:1,slidesToScroll:1,nextArrow:'<span class="nextArrow"></span>',prevArrow:'<span class="prevArrow"></span>'});var t=$("[data-zakaz-counter]");t.length&&t.zakazCounter(),$("[data-counter='plus'], [data-counter='minus']").click(function(){var e=$(".counter").val();console.log(e);var t=250;console.log(t);var n=e*t;console.log(n),$(".summa").text(n)})}();
